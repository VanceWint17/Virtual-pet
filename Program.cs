    ...
    while (createNew)
    {
        ...
        while (isRunning)
        {
...

            {
                ...
                Console.WriteLine("5 Add or Remove your pet to shelter");
                ...
                switch (choice)
                {
                    ...
                    case "5":
                        ...
                        if (userInput2 == 1)
                        {
                            ...
                            int index = Convert.ToInt32(Console.ReadLine());
                            shelter.AddPet(organicPetList[index - 1]);
                        }
                        else if (userInput2 == 2)
                        {
                            ...
                            int index = Convert.ToInt32(Console.ReadLine());
                            shelter.RemovePet(organicPetList[index - 1]);
            ...
            else if (petType == "2")
            {
                ...
                if (option)
                {
                    ...
                    Console.WriteLine("Options are Slot 1, Slot 2, Slot 3, Slot 4");
                    int index = Convert.ToInt32(Console.ReadLine());
                    myRobot = roboticPetList[index - 1];
                    option = false;
                }
                ...
                switch (choice)
                {
                    ...
                    case "5":
                        ...
                        if (userInput2 == 1)
                        {
                            ...
                            int index = Convert.ToInt32(Console.ReadLine());
                            shelter.AddPet1(roboticPetList[index - 1]);
                        }
                        else if (userInput2 == 2)
                        {
                            Console.WriteLine("What pet would you like to remove");
                            int index = Convert.ToInt32(Console.ReadLine());
                            shelter.RemovePet(roboticPetList[index - 1]);
                        }
                        break;
                    default:
                        break;
